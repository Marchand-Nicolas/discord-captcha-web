    ...
    <>
      ...
      <section id="description">
        ...
        <div className={styles.exampleContainer}>
          ...
          <p>
            ...
            <br></br>
            <br></br>
            Captcha bot automatically generates an image containing text, which
            is very difficult for a robot to understand. It therefore prevents
            waves of automated users destroying your server.
          </p>
        </div>
        <div className={[styles.exampleContainer, styles.reverse].join(" ")}>
          ...
          <p>
            <strong className={styles.strong}>
              One command, 100% customizable
            </strong>
            <br></br>
            <br></br>
            In a single command, change the avatar and name of the bot, as well
            as the title and description of the embed.
          </p>
        </div>
        <div className={styles.exampleContainer}>
          <div className={[styles.glassCard, styles.v2].join(" ")}>
            ...
            <img
              ...
              className={[styles.shape, styles.v1].join(" ")}
            />
          </div>
          <p>
            ...
            <br></br>
            <br></br>
            To reduce the risk of damage in case of hacking, the bot only asks
            you for the permissions it needs. Moreover, the bot is hosted on
            several servers simultaneously, so even if one of them has a
            problem, the rest of the infrastructure continues to work, thus
            protecting your server 24/7.
          </p>
        </div>
      </section>
      ...
      <section id="informations" className={styles.main}>
        <div className={styles.grid}>
          ...
          <a
            href="https://discord.gg/Edb5UUsnTy"
            rel="noreferrer"
